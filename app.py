    ...
    if request.method == 'POST':
        ...
        try:
            if action == 'zakup':
                ...
                product = Product.query.filter_by(name=product_name, warehouse_id=warehouse.id).first()
                if not product:
                ...
                warehouse.save_to_db()
                action_desc = f'Kupiono {pieces_number} szt. {product_name} za {product_price} zł'
